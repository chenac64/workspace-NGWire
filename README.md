# com-chilipeppr-workspace-NGWire
A ChiliPeppr Workspace NGWire.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / NGWire
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-NGWire |
| Name                  | Workspace / NGWire |
| Description           | A ChiliPeppr Workspace NGWire. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/https://master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/root/workspace-NGWire |
| Github URL            | http://github.com/https:/ |
| Test URL              | https://preview.c9users.io/root/workspace-NGWire/workspace.html |
...
chilipeppr.load(
  ...
  function() {
    ...
    cprequire(
      ["inline:com-chilipeppr-workspace-NGWire"], // the id you gave your workspace
      function(myWorkspaceNGWire) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / NGWire just got loaded.", myWorkspaceNGWire);
        myWorkspaceNGWire.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-NGWire"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / NGWire"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace NGWire."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/https://master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/root/workspace-NGWire"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/https:/"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://workspace-NGWire-root.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
