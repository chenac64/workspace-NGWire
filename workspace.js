...
cprequire_test(["inline:com-chilipeppr-workspace-NGWire"], function(ws) {
    ...
    $('title').html("NGWire Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-NGWire", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-NGWire", // Make the id the same as the cpdefine id
        name: "Workspace / NGWire", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace NGWire.`,
